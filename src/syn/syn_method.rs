...
impl From<UnprocessedMethod> for SynMethod {
    fn from(u: UnprocessedMethod) -> Self {
        ...
        let (type_ids, ds): (TypeIdentifiers, Option<DSName>) =
            TypeIdentifiers::from_impl_signature(&impl_sig);
        let ds: DSName = ds.unwrap_or_default();
        SynMethod {
            file: u.file,
...
// impl HasByteRange for SynMethod {
//     fn byte_range(&self) -> &ByteRange {
//         &self.method_body.range.byte_range
//     }
// }
