...
impl AllUnprocessedElements {
    pub fn from_raw_json(json: &str) -> Result<Self, serde_json::Error> {
        let (
            ...
            raw_unions,
            raw_mods,
            raw_expression_statements,
            raw_use_declarations,
            raw_macro_definitions,
            raw_macro_invocations,
        ...
        Ok(AllUnprocessedElements {
            ...
            unprocessed_mods: collect_unprocessed!(raw_mods                  => UnprocessedMods),
            unprocessed_expression_statements: collect_unprocessed!(raw_expression_statements => UnprocessedExpressionStatements),
            unprocessed_use_declarations: collect_unprocessed!(raw_use_declarations      => UnprocessedUseDeclarations),
            unprocessed_macro_definitions: collect_unprocessed!(raw_macro_definitions     => UnprocessedMacroDefinitions),
            unprocessed_macro_invocations: collect_unprocessed!(raw_macro_invocations     => UnprocessedMacroInvocations),
        })
    }
}
